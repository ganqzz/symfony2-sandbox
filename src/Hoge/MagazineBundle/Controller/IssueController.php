...
use Hoge\MagazineBundle\Entity\Issue;
use Hoge\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HogeMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("HogeMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HogeMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HogeMagazineBundle:Issue:edit.html.twig")
     */
